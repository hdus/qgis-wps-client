       ...
       # Raster data
        ...
        if not bLoaded:
            QMessageBox.information(self.iface.mainWindow(), 
                ...
                QApplication.translate("QgsWps","It seems QGIS cannot load the result of the process. The result has a '{mimeType}' type and can be accessed at '{result}'. \n\nYou could ask the service provider to consider changing the default data type of the result.").format(mimeType=self.mimeType , result = resultFile))
